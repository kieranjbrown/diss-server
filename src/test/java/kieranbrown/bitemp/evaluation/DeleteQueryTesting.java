...
//        private final List<Integer> thresholds = List.of(100, 1000);
    private final List<Integer> thresholds = List.of(10000);
    @PersistenceContext
    ...
    private void testQueryMariadb() throws
        ...
        for (int x : thresholds) {
            ...
            final int updates = entityManager
                    .createNativeQuery("delete from reporting.trade_data for system_time as of timestamp " +
